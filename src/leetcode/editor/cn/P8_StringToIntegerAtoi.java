        ...
        public int myAtoi(String s) {
            ...
            for (int i = 0; i < s.length(); i++) {
                if (isDigit(s.charAt(i))) {
                    if (ans / 10 < Integer.MAX_VALUE / 10 ||
                            (ans / 10 == Integer.MAX_VALUE / 10 && s.charAt(i) <= '7')) {
...
//            System.out.println("myAtoi : "+s+" -> "+check(ans, temp));
            return check(ans, flag != 0 ? flag : 1);
        ...
        private int check(long num, int flag) {
            if (flag == 1) {
                return num > Integer.MAX_VALUE ? Integer.MAX_VALUE : (int) num;
            } else {
                return -1 * (num > Integer.MAX_VALUE ? Integer.MAX_VALUE + 1 : (int) num);
            }
        }
    }
