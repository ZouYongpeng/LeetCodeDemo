...
//                System.out.println("execute: find l = "+left+", r = "+right);
                stringBuilder.append(right - left);
                stringBuilder.append(str.charAt(left));
//                System.out.println("execute: append "+(right - left)+"+"+str.charAt(left));
                left = right;
            }
//            System.out.println("execute: "+str+" -> "+stringBuilder.toString());
